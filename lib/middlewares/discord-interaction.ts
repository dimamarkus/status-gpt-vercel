...
import { DiscordInteractionApiHandler } from "#/lib/interfaces/discord"
import { NextApiRequest, NextApiResponse } from "next"
import nacl from "tweetnacl"
import { parseRawBodyAsString } from "#/lib/helpers/functions/body-parser"
...
const withDiscordInteraction = (next: DiscordInteractionApiHandler) => async (
  ...
  try {
    ...
    if (type === 1 as InteractionType.ApplicationCommand) {
