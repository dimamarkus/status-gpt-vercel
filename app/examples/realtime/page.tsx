...
export default async function Realtime() {
  ...
  return (
    <div className="prose-sm prose-invert prose max-w-none">
      ...
      <ul>
        <li>
          This component fetches the current products server-side and subscribes
          to new products client-side
        </li>
        <li>
          Data can be passed from server components to client components this
          allows us to fetch the initial products before rendering the page our
          {'<RealtimeProducts />'} component will then subscribe to new products
          client-side
        </li>
        <li>
          Try adding a product on the database to see if it appears on this page
        </li>
      </ul>
